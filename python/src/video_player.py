...
class VideoPlayer:
    ...
    def play_video(self, video_id):
        ...
        """
        video_on_play = self._video_library.get_video(video_id)
        if video_on_play is None:
            print(f"Cannot play video: Video does not exist!")
        else:
            if self.video_ongoing is True:
                print(f"Stopping video: {self.current_video.title}")
            print(f"Playing video: {video_on_play.title}")
            self.video_ongoing = True
            self.current_video = video_on_play
